...
For image bundling or data that is separate such as member or items (`items` fragment) files a subdirectory can be used.  
...
The attributes and content of this file are passed to the specified fragment (`fragment = "content"`).
